  ...
  <section class="unified" id="unifiedEntry">
    ...
    <div class="udetail" id="unifiedDetail" hidden>
      <div class="uform">
        ...
        <div class="uhint" id="unifiedHint">同一端口同时支持 SOCKS5 与 HTTP/HTTPS（CONNECT）。所有用户共用一个端口，按用户名密码路由到各自专属的 Tunnel；同一 Tunnel 只能属于一个用户，请求失败不会回退到本机网络。</div>
      </div>
...
<div class="modal" id="unifiedcfg">
  <div class="sheet">
    ...
    <div class="body">
      ...
      <div class="hint">启用后同一端口同时接受 SOCKS5 与 HTTP/HTTPS（CONNECT）。停用时保留各 Tunnel 独立入口。</div>
