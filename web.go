  ...
  <section class="unified" id="unifiedEntry">
    ...
    <div class="udetail" id="unifiedDetail" hidden>
      <div class="uform">
        ...
        <div class="uhint" id="unifiedHint">所有用户共用一个端口，按用户名密码路由到各自专属的 Tunnel；同一 Tunnel 只能属于一个用户，请求失败不会回退到本机网络。</div>
      </div>
